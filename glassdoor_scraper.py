# -*- coding: utf-8 -*-
"""
Created on Wed Jun  8 06:22:59 2022
...
def get_jobs(keyword, num_jobs, verbose,path,slp_time):
    ...
    url = 'https://www.glassdoor.com/Job/data-scientist-jobs-SRCH_KO0,14.htm?radius=100&sortBy=date_desc'
    driver.get(url)
    jobs = []
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        if not (len(jobs) >= num_jobs):
            ...
            try:                
                #driver.find_element_by_xpath('.//li[@class="nextButton"]//a').click()
                driver.find_element_by_xpath('//*[@id="MainCol"]//button[@data-test="pagination-next"]').click()
